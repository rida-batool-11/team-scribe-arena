...
const HomePage = () => {
  return (
    <>
      ...
      >
        <TitleSection
          pill="✨ Intiate, Integrate, Innovate"
      ...
      >
        ...
        />
        <TitleSection
          title="Keep track of your documents all in one place"
            ...
            <div
              ...
              className={twMerge(
                clsx("mt-10 flex flex-nowrap gap-6 self-start", {
                  ...
                  "animate-[slide_50s_linear_infinite]": true,
                  "animate-[slide_50s_linear_infinite_reverse]": index === 1,
                  "ml-[100vw]": index === 1,
                }),
                "hover:paused"
              )}
      ...
      >
        ...
        <section className="pt-16 pb-6 text-center font-sans text-lg font-light	">
            © <span className="font-medium">TSA</span>. All rights reserved.
        </section>
    </>
  );
};
